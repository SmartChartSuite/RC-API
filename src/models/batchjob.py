...
from src.models.models import JobStartParameter

"""
Models for the BatchJob Post
"""
...
class BatchParametersJob(BaseModel):
    ...
    resourceType: str = "Parameters"
    parameter: list = [BatchIdParameter(), BatchPatientIdParameter(), BatchJobPackageParameter(), JobStartParameter(), BatchJobListPararameter(), BatchJobPatientIncludedParameter()]
